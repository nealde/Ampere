...
class SingleParticle(BaseBattery):
    ...
    def __init__(self, initial_parameters=None, verbose=False, **kwargs):
        ...
        | an     | Surface area of negative electrode          | 723600        |         |
        | ap     | Surface area of positive electrode          | 885000        |         |
        ...
        | kn     | Negative electrode reaction rate            | 5.0307e-9     |         |
        | kp     | Positive electrode reaction rate            | 2.334e-9      |         |
